...
import com.icloudoor.cloudoor.SetGestureConstants;
...
public class GestureDrawLineView extends View {
	...
	public GestureDrawLineView(Context context, List<GesturePoint> list, boolean isVerify,
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		paint.setColor(Color.rgb(255,250,240));
