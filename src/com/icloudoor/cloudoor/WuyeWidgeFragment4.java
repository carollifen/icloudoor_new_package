 ...
 *
 */
public class WuyeWidgeFragment4 extends Fragment {
	...
	private String imageName = "myCachePic4.jpg";

	boolean isDebug = DEBUG.isDebug;
	
	public WuyeWidgeFragment4() {
...
//						bgImage.setImageBitmap(bm);
			...
			String tempString = banner.getString("4link", null);
			if (tempString != null){
				if (tempString.length() > 0){
					link = banner.getString("4link", null);
